...
/**
 * Created by beslimir on 24.01.18..
 */
...
public class ParseData extends AppCompatActivity {
    ...
    static final String TAG = "LedControl";
    ...
    private void turnOnLed() {
        if (btSocket != null) {
            try {
                ...
                Log.i(TAG, "Input: " + btSocket.getInputStream().read());
                Log.i(TAG, "LED turned on (1)!");
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ParseData.this, "Connecting...", "Please wait!!!");  //show a progress dialog
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Log.i(TAG, "aa: " + handlerState + " " + bytes + " " + readMessage);
                } catch (IOException e) {
                    break;
                }
            }
